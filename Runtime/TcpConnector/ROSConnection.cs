...
public class ROSConnection : MonoBehaviour
{
    ...
    // Variables required to keep the connections open
    ...
    private void OnApplicationQuit()
    {
        if (tcpListener != null)
            tcpListener.Stop();
        tcpListener = null;
        if (persistantNetworkStream != null)
        {
            persistantNetworkStream.Close();
            persistantNetworkStream = null;
        }
        if (persistantClient != null)
        {
            if (persistantClient.Connected)
                persistantClient.Close();
            persistantClient = null;
        }
    }
    ...
    protected void Connect()
    {
        ...
        lock(_connectionLock)
        {
            if (persistantClient == null || !persistantClient.Connected )
            {
                ...
                Debug.Log("Connecting persistent client ...");
                ...
                Debug.Log("Connected persistent client");
            }
        }
    }
